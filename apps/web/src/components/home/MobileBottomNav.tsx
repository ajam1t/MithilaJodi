    ...
    >
      ...
      {authLoaded && loggedIn ? (
        ...
        <div className="flex items-stretch">
          ...
          {/* Search */}
          <Link href="/search" className="flex-1 flex flex-col items-center gap-0.5 py-2.5 text-maroon hover:text-terra active:text-terra transition-colors">
            <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" aria-hidden="true">
              <circle cx="11" cy="11" r="8" /><line x1="21" y1="21" x2="16.65" y2="16.65" />
            </svg>
            <span className="text-[10px] font-medium tracking-wide leading-none">Search</span>
          </Link>
          ...
          {/* Interests */}
          <Link href="/interests" className="flex-1 flex flex-col items-center gap-0.5 py-2.5 text-maroon hover:text-terra active:text-terra transition-colors">
            <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" aria-hidden="true">
              <path d="M20.84 4.61a5.5 5.5 0 0 0-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 0 0-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 0 0 0-7.78z" />
            </svg>
            <span className="text-[10px] font-medium tracking-wide leading-none">Interests</span>
          </Link>

          {/* Profile */}
          <Link href="/profile" className="flex-1 flex flex-col items-center gap-0.5 py-2.5 text-maroon hover:text-terra active:text-terra transition-colors">
            <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" aria-hidden="true">
              <path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2" />
              <circle cx="12" cy="7" r="4" />
            </svg>
            <span className="text-[10px] font-medium tracking-wide leading-none">Profile</span>
          </Link>
        </div>
      ) : (
