...
export function BiodataSection() {
  return (
    <section id="biodata" className="relative bg-cream py-10" aria-label="Marriage biodata in your language">
      <div className="wrap">
        <div className="text-center mb-7">
          <p className="eyebrow mb-2">Your Language</p>
        ...
        <div className="max-w-2xl mx-auto text-center">
          <p className="text-ink-soft text-[15px] leading-relaxed mb-6">
            Create your marriage biodata in <span className="font-deva text-maroon">मैथिली</span>, हिन्दी, English, or Sanskrit.
            Your profile, your words, your culture — never forced into a single language.
          </p>

          {/* Language pills */}
          <div className="flex gap-2 flex-wrap justify-center mb-7" aria-label="Supported languages">
            {LANGS.map(l => (
              <span
                key={l.script}
          ...
          {/* Feature bullets */}
          <ul className="text-left inline-block space-y-2 text-[13px] text-ink-soft mb-7">
            {[
