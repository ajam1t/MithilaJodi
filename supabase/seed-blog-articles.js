'use strict'
/**
 * seed-blog-articles.js
 * Inserts the 10 Maithil marriage ritual articles and renames the category.
 * Run once from the project root:
 *   node supabase/seed-blog-articles.js
 *
 * Reads NEXT_PUBLIC_SUPABASE_URL + SUPABASE_SERVICE_ROLE_KEY from
 * apps/web/.env.local (or .env.local at the root).
 */
...
// ── A: Cornerstone ──────────────────────────────────────────
{
  slug: 'complete-guide-maithil-vivah',
  title: 'Complete Guide to Maithil Vivah: Rituals, Ceremonies and Traditions',
  excerpt: 'A Maithil wedding unfolds across several days and is filled with rituals unique to the Mithila tradition. This complete guide walks you through every stage — from the first formal meeting to Dwiragaman.',
  content: `## What Is Maithil Vivah?
...
Each ceremony in this guide has its own dedicated article — use the links throughout this page to go deeper into any specific ritual that interests you.`,
  seo_title: 'Complete Guide to Maithil Vivah: Rituals, Ceremonies and Traditions | Mithila Jodi',
  seo_description: 'A complete guide to traditional Maithil vivah — from Siddhant and Tilak through the wedding ceremony, Kohbar Ghar, Sindoor Daan, Chaturthi and Dwiragaman. Understand every stage of the Maithil marriage journey.',
  keywords: ['maithil vivah', 'mithila wedding guide', 'maithil wedding rituals', 'mithila marriage complete guide', 'maithil vivah traditions', 'mithila wedding ceremony'],
  featured: true,
},

// ── B: Kohbar ───────────────────────────────────────────────
{
  slug: 'kohbar-kohbar-ghar-mithila-marriage',
  title: 'What Is Kohbar in Mithila Marriage? The Tradition of the Kohbar Ghar',
  excerpt: 'The Kohbar Ghar is the sacred room at the heart of a traditional Maithil wedding — decorated with Madhubani paintings full of symbolic meaning. Learn what Kohbar is, what its paintings mean, and how this tradition is observed today.',
  content: `## What Is Kohbar?
...
Kohbar is a distinctive part of traditional Maithil weddings and is observed by many families, though the specific form varies. Some maintain the full tradition with hand-painted walls; others adapt it for modern settings.`,
  seo_title: 'What Is Kohbar in Mithila Marriage? The Tradition of Kohbar Ghar | Mithila Jodi',
  seo_description: 'Discover what Kohbar means in Mithila marriage, the symbolism behind Kohbar Ghar paintings — fish, lotus, bamboo and more — and how this Madhubani art tradition is observed in Maithil weddings today.',
  keywords: ['kohbar mithila marriage', 'kohbar ghar', 'kohbar tradition', 'maithil wedding kohbar', 'kohbar painting mithila', 'mithila wedding traditions'],
  featured: false,
},

// ── C: Tilak ────────────────────────────────────────────────
{
  slug: 'tilak-ceremony-maithil-marriage',
  title: 'Tilak Ceremony in Maithil Marriage: What Happens and Why It Matters',
  excerpt: 'The Tilak ceremony is the formal engagement in a Maithil wedding — when the bride\'s family visits the groom\'s home and publicly declares the match. Learn what happens, who participates and what it signifies.',
  content: `## What Is the Tilak Ceremony?
...
| Who leads | Family purohit | Bride's father or senior male relatives |
...
Practices vary. In more traditional settings, the ceremony is primarily between the male representatives of both families. In modern practice, both the bride and groom may be present.`,
  seo_title: 'Tilak Ceremony in Maithil Marriage: What Happens and Why It Matters | Mithila Jodi',
  seo_description: 'Learn about the Tilak ceremony in Maithil marriage — the formal engagement where the bride\'s family visits the groom\'s home, applies the tilak mark, exchanges gifts and publicly declares the match.',
  keywords: ['tilak ceremony mithila', 'tilak maithil marriage', 'tilak ceremony mithila wedding', 'maithil engagement ceremony', 'mithila tilak tradition'],
  featured: false,
},

// ── D: Siddhant ─────────────────────────────────────────────
{
  slug: 'siddhant-ceremony-mithila-marriage',
  title: 'What Is the Siddhant Ceremony in Mithila Marriage?',
  excerpt: 'Siddhant is the formal, priest-witnessed confirmation of a matrimonial match in Maithil tradition — the ceremony that turns a private family understanding into a sanctioned commitment. Learn what happens and why it matters.',
  content: `## What Is the Siddhant Ceremony?
...
In many families, the purohit makes a record of this — the names, gotras and the date of the agreement may be noted in the family's ritual register. This creates a community record of the commitment.
...
**Protecting the integrity of the match:** Once Siddhant has been observed, withdrawing from a match is considered a serious matter with social and moral implications.

**Lineage integrity:** The formal verification of gotra and mool at Siddhant protects both families from discovering an inadvertent close-kin connection at a later stage.
...
Like all Maithil marriage customs, Siddhant is observed differently by different families and communities. Some families conduct an elaborate Siddhant with full ritual; others observe a simpler form. In some modern families, particularly in cities, the Siddhant may be a more informal occasion.
...
The purohit acts as ritual witness, record-keeper and the source of religious sanction. They verify lineage details, recite appropriate mantras, and formally bless the families' agreement.`,
  seo_title: 'What Is the Siddhant Ceremony in Mithila Marriage? | Mithila Jodi',
  seo_description: 'Understand the Siddhant ceremony — the formal, priest-witnessed confirmation of a Maithil matrimonial match that verifies lineage and seals the agreement before Tilak and the wedding.',
  keywords: ['siddhant ceremony mithila', 'siddhant maithil marriage', 'mithila pre-wedding ceremony', 'maithil vivah siddhant', 'mithila wedding rituals before tilak'],
  featured: false,
},

// ── E: Chaturthi ────────────────────────────────────────────
{
  slug: 'chaturthi-mithila-marriage',
  title: 'Chaturthi in Mithila Marriage: The Fourth-Day Post-Wedding Ceremony',
  excerpt: 'Chaturthi is the important fourth-day ceremony after a Maithil wedding — a ritual that marks the couple\'s formal beginning of their shared life. Learn what happens, why it matters and how different families observe it.',
  content: `## What Is Chaturthi?
...
Chaturthi is sometimes understood as the formal beginning of the couple's shared domestic life. Certain rituals and tasks performed on this day mark the couple's establishment as a new unit within the broader family. The bride's place in the household, which was new and uncertain on the wedding day, begins to settle at Chaturthi.

### Family Gathering

Chaturthi brings both families together again after the wedding. Relatives who were unable to stay for all of the wedding ceremonies often join on the fourth day. There is typically a shared meal, and the atmosphere is more relaxed than the wedding itself.
...
The bride's family often presents additional gifts on Chaturthi — to the couple, and sometimes to members of the groom's household. These are separate from the wedding gifts and represent an ongoing expression of goodwill toward the new family that the bride has joined.
...
In the context of marriage, the fourth day represents consolidation. The wedding has been performed; the couple has spent their first days together; the initial intensity of the ceremony has settled. Chaturthi marks this settling — a formal acknowledgment that the marriage has begun.
...
On the fourth day after the main wedding ceremony. The exact counting may vary slightly in how different families measure it.
...
Chaturthi is widely recognised as part of the Maithil tradition, but the form and elaborateness varies by family. Your family's purohit and elders will guide you.`,
  seo_title: 'Chaturthi in Mithila Marriage: The Fourth-Day Post-Wedding Ceremony | Mithila Jodi',
  seo_description: 'Learn about Chaturthi — the fourth-day ceremony in a Maithil wedding that marks the couple\'s formal beginning of shared life through puja, family gathering and Maithili songs.',
  keywords: ['chaturthi mithila marriage', 'chaturthi maithil wedding', 'post wedding ceremony mithila', 'fourth day wedding ritual mithila', 'maithil vivah chaturthi'],
  featured: false,
},

// ── F: Sindoor Daan ─────────────────────────────────────────
{
  slug: 'sindoor-daan-maithil-marriage',
  title: 'Sindoor Daan in Maithil Marriage: Meaning, Ritual and Significance',
  excerpt: 'Sindoor Daan — the groom applying vermilion to the bride\'s maang — is one of the most sacred moments of a Maithil wedding. Learn when it happens, how it is performed and what it means in the Mithila tradition.',
  content: `## What Is Sindoor Daan?
...
A small amount of sindoor is prepared — placed in the groom's right hand or on a small silver plate or a leaf. The purohit recites the appropriate mantras, invoking blessings for the couple and the sanctity of the act.
...
**The visible sign of marriage:** Sindoor is among the most recognisable and socially understood symbols of married status in Hindu North India. From the moment of Sindoor Daan, the bride wears this mark.
...
Some women wear sindoor every day; others on auspicious occasions; others may not continue the practice at all. All of these choices are made within the individual and family's own understanding of tradition.
...
Practices vary between families and generations. Many women continue the tradition as a daily practice; others observe it selectively. It is a personal and cultural choice.`,
  seo_title: 'Sindoor Daan in Maithil Marriage: Meaning, Ritual and Significance | Mithila Jodi',
  seo_description: 'Learn about Sindoor Daan in Maithil marriage — when it happens in the ceremony, how the groom applies sindoor to the bride\'s maang, and what this deeply significant ritual means in the Mithila tradition.',
  keywords: ['sindoor daan mithila', 'sindoor daan maithil marriage', 'sindoor ceremony mithila', 'sindoor daan meaning', 'mithila wedding sindoor'],
  featured: false,
},

// ── G: Dwiragaman ───────────────────────────────────────────
{
  slug: 'dwiragaman-mithila-marriage',
  title: 'What Is Dwiragaman? The Ritual That Closes the Maithil Wedding Journey',
  excerpt: 'Dwiragaman — the "second departure" — is the final post-wedding ritual in a traditional Maithil marriage. The bride returns to her natal home for a ceremonial visit, then departs again to formally begin her life in the marital home.',
  content: `## What Is Dwiragaman?
...
The Vidai immediately after the wedding is sudden and overwhelming. The bride is leaving in the midst of the ceremony's intensity, surrounded by the full gathering of the day, often in tears.

Dwiragaman offers something different — a more considered farewell. The family has had time to breathe after the wedding. They have received the couple back and seen them together. The bride has had time to visit her home not as a daughter who is about to leave, but as a daughter who has left and returned.

When Dwiragaman happens, the departure is no less felt — but it is more conscious. The bride chooses to leave. The family has the chance to say goodbye with the clarity that comes after the initial intensity of the wedding has settled.
...
When the couple arrives at the groom's home after Dwiragaman, the return may be accompanied by welcoming rituals from the groom's household — marking the bride's more settled arrival.
...
In modern practice, Dwiragaman continues to be observed in many Maithil families. The distances between families, the practical constraints of leave from work, and other modern circumstances sometimes require adaptation. The ritual essence is maintained: the return, the time spent together, the blessing, the second departure.
...
Timing varies by family — typically a few days to a few weeks after the wedding, often following the Chaturthi ceremony.
...
It is a recognised and widely observed part of the Maithil tradition, though specific forms and timing vary. It is more commonly observed in families with strong traditional practice.`,
  seo_title: 'What Is Dwiragaman? The Ritual That Closes the Maithil Wedding Journey | Mithila Jodi',
  seo_description: 'Learn about Dwiragaman — the post-wedding ritual in which the Maithil bride returns to her natal home and then departs for the last time, formally concluding the marriage process.',
  keywords: ['dwiragaman mithila marriage', 'dwiragaman maithil wedding', 'dwiragaman meaning', 'mithila post wedding rituals', 'maithil vivah dwiragaman'],
  featured: false,
},

// ── H: Wedding Songs ─────────────────────────────────────────
{
  slug: 'maithili-wedding-songs-sohar-geet',
  title: 'Maithili Wedding Songs: Sohar, Geet and the Voice of a Mithila Wedding',
  excerpt: 'In a Maithil wedding, music is not decoration — it is ritual. Women sing Maithili songs at every stage of the marriage, from the tilak to the vidai. Learn about sohar, geet and the living musical tradition of the Mithila wedding.',
  content: `## Music as Ritual in a Maithil Wedding
...
Any discussion of Maithili music must acknowledge **Vidyapati** (c. 1352–1448) — the medieval poet-saint whose compositions in Maithili remain among the most cherished in the tradition. Vidyapati wrote devotional compositions addressed to the divine — using the imagery of love and longing to explore the soul's relationship with god.

His influence on Maithili's musical and poetic identity is profound. The tradition of women's communal singing in Maithili — at weddings, at festivals, at family ceremonies — exists within the same cultural world that produced Vidyapati's work. For a broader introduction to the language and its cultural significance, see [Maithili Language and Mithila Identity](/blogs/mithila-culture-heritage/maithili-language-identity).
...
In some families, the full complement of songs is sung at every appropriate moment. In others, a smaller selection is sung at key occasions. In some urban settings, professional singers or musicians perform Maithili songs during celebrations.
...
Primarily through an oral tradition — women learn by listening to and singing with older female relatives across many family occasions.
...
Many families seek out recordings, community sources or professional singers to bring Maithili music into their wedding. The tradition is flexible enough to accommodate different levels of knowledge while still preserving its spirit.`,
  seo_title: 'Maithili Wedding Songs: Sohar, Geet and the Voice of a Mithila Wedding | Mithila Jodi',
  seo_description: 'Discover the role of Maithili wedding songs in a traditional Maithil wedding — sohar, Kohar geet, Vidai songs, Parichhan geet and more. Understand how these songs are passed down and why they matter.',
  keywords: ['maithili wedding songs', 'sohar song mithila', 'maithili wedding geet', 'mithila wedding music', 'sohar maithili', 'maithil vivah songs'],
  featured: false,
},

// ── I: Parichhan ─────────────────────────────────────────────
{
  slug: 'parichhan-maithil-wedding',
  title: 'What Is Parichhan in a Maithil Wedding? The Formal Welcome of the Groom',
  excerpt: 'When the groom\'s wedding party arrives, they are welcomed through Parichhan — a ritual of arati, songs and offerings unique to the Maithil wedding. Learn what happens, who performs it and what it means.',
  content: `## What Is Parichhan?
...
Parichhan takes place on the wedding day, when the groom's baraat arrives at the bride's home or the wedding venue. It happens before the main wedding ceremony begins — the Parichhan is the formal opening of the wedding day for the groom's arrival.
...
The central element of Parichhan is the **arati** — the ritual of the lamp. A senior woman, typically the bride's mother, performs arati for the groom: a lit lamp or a thali (plate) bearing a flame is moved in a circular motion before the groom's face, accompanied by prayers or the recitation of auspicious words.
...
As part of Parichhan, the bride's mother or another senior woman may apply an auspicious tika to the groom's forehead — a mark of welcome and blessing for the wedding day. This is distinct from the formal tilak applied at the [Tilak ceremony](/blogs/mithila-marriage-traditions/tilak-ceremony-maithil-marriage) earlier in the engagement process.
...
Even in families where many other traditional elements have evolved or been simplified, the Parichhan tends to survive. The mother welcoming the son-in-law with a lamp in her hands is an image that speaks across generations.
...
**When does Parichhan take place?**
When the groom's wedding party arrives at the venue, before the main wedding ceremony begins.

**Is the Parichhan tika the same as the Tilak engagement?**
No — these are separate ceremonies. The Tilak engagement (performed weeks before the wedding) is the formal engagement ceremony. The tika at Parichhan is a welcome mark applied on the wedding day when the groom arrives.`,
  seo_title: 'What Is Parichhan in a Maithil Wedding? The Formal Welcome of the Groom | Mithila Jodi',
  seo_description: 'Learn about Parichhan — the Maithil wedding ceremony where the women of the bride\'s family formally welcome the groom\'s baraat with arati, songs and offerings on the wedding day.',
  keywords: ['parichhan maithil wedding', 'parichhan mithila wedding', 'groom welcome mithila wedding', 'baraat welcome mithila', 'maithil vivah parichhan'],
  featured: false,
},

// ── J: Naina Jogin ───────────────────────────────────────────
{
  slug: 'naina-jogin-maithil-wedding',
  title: 'Naina Jogin in Maithil Wedding Tradition: A Pre-Wedding Protective Ritual',
  excerpt: 'Naina Jogin is a pre-wedding protective tradition observed in many Maithil families — prayers and offerings seeking divine blessing and protection for the couple before the wedding. Learn what it involves and why it varies between families.',
  content: `## What Is Naina Jogin?
...
The family purohit may lead prayers appropriate to the occasion, or a senior woman of the household may lead the ritual recitation. Specific mantras or more general protective prayers are offered, depending on the family's practice.
...
Naina Jogin is typically observed in the days before the main wedding ceremony — often the night before the wedding, or two to three days before. The timing is chosen in consultation with the family purohit.

## Naina Jogin Within the Broader Tradition

The Naina Jogin ritual belongs to a category of protective and preparatory practices that exist across many North Indian communities. Before important events — particularly weddings — families across many Hindu traditions observe some form of protective ritual: offerings to the kula devi (family deity), prayers for the household, the tying of protective threads around the wrists of the couple.
...
No — practices vary significantly between families, regions and communities. Some observe it in full form; others in a simpler way; others do not observe it at all. Your family purohit and elders are the best guide.`,
  seo_title: 'Naina Jogin in Maithil Wedding Tradition: A Pre-Wedding Protective Ritual | Mithila Jodi',
  seo_description: 'Learn about Naina Jogin — the pre-wedding protective ritual observed in many Maithil families, involving prayers and offerings to seek divine blessings for the couple before the wedding.',
  keywords: ['naina jogin mithila', 'naina jogin maithil wedding', 'mithila pre-wedding ritual', 'protective ritual mithila wedding', 'maithil vivah naina jogin'],
  featured: false,
},
...
async function main () {
  ...
  if (!url || !key) {
    ...
    console.error('Checked: apps/web/.env.local, .env.local, .env')
    process.exit(1)
  }
  ...
  const { error: catErr } = await sb
    ...
    .eq('slug', 'mithila-marriage-traditions')
  if (catErr) console.error('Category update error:', catErr.message)
  else         console.log('Category renamed to "Mithila Marriage Rituals & Traditions"')

  // 2. Get category id
  const { data: cat, error: catFetchErr } = await sb
    .from('blog_categories')
    .select('id')
    .eq('slug', 'mithila-marriage-traditions')
    .single()
  if (catFetchErr || !cat) {
    console.error('Could not find category:', catFetchErr?.message)
    process.exit(1)
  }

  // 3. Insert / upsert articles
  let ok = 0, fail = 0
  for (const article of ARTICLES) {
    const { error } = await sb.from('blog_posts').upsert(
      {
        category_id:  cat.id,
        author_name:  'Mithila Jodi Team',
        status:       'published',
    ...
    if (error) { console.error(`FAIL ${article.slug}: ${error.message}`); fail++ }
    else       { console.log(`  OK  ${article.slug}`); ok++ }
  }
